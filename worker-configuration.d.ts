/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e00b5ae872325d415eeb60fd36d03027)
// Runtime types generated with workerd@1.20251118.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "ResearchAgent" | "SupportAgent" | "WorkflowAgent";
	}
	interface Env {
		...
		ResearchAgent: DurableObjectNamespace<import("./workers/app").ResearchAgent>;
		SupportAgent: DurableObjectNamespace<import("./workers/app").SupportAgent>;
		WorkflowAgent: DurableObjectNamespace<import("./workers/app").WorkflowAgent>;
		GREATING_WORKFLOW: Workflow<Parameters<import("./workers/app").GreatingWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "OPENAI_API_KEY" | "ANTHROPIC_API_KEY" | "GOOGLE_AI_API_KEY" | "FIRECRAWL_API_KEY">> {}
}
